...
The frontend code is super messy and clumped together since this was made in like 1 day lmao. (still not even done) <br>
This is also an "upgraded" version of the old gensokyo.
